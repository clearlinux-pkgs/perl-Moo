...
Version  : 2.004002
Release  : 15
URL      : https://cpan.metacpan.org/authors/id/H/HA/HAARG/Moo-2.004002.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/H/HA/HAARG/Moo-2.004002.tar.gz
...
%prep
%setup -q -n Moo-2.004002
cd %{_builddir}/Moo-2.004002
...
cp %{_builddir}/Moo-2.004002/LICENSE %{buildroot}/usr/share/package-licenses/perl-Moo/8f372b06a35afe677e873c9fd12758676b74ba03
if test -f Makefile.PL; then
