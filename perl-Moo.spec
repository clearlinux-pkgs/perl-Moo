...
Source0  : https://cpan.metacpan.org/authors/id/H/HA/HAARG/Moo-2.005003.tar.gz
...
%prep
%setup -q -n Moo-2.005003
cd %{_builddir}/Moo-2.005003
...
cp %{_builddir}/Moo-2.005003/LICENSE %{buildroot}/usr/share/package-licenses/perl-Moo/f7f18487ddc4af5caae4b3d4bce309474c8e2915
if test -f Makefile.PL; then
