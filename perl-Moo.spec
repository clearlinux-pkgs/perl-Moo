...
%prep
%setup -q -n Moo-2.004004
cd %{_builddir}/Moo-2.004004
...
cp %{_builddir}/Moo-2.004004/LICENSE %{buildroot}/usr/share/package-licenses/perl-Moo/8f372b06a35afe677e873c9fd12758676b74ba03
if test -f Makefile.PL; then
